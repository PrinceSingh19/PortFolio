...
const Intro = () => {
	return (
		<div className="flex flex-col px-10 h-screen justify-center md:ml-40">
			<h3 className="text-textColor md:text-xl">Hi,</h3>
			<h3 className="text-textColor md:text-xl">My name is,</h3>
			<h1 className="text-slate-300 text-3xl md:text-7xl font-semibold"> Prince Singh.</h1>{" "}
			...
			<p className="text-lg md:text-xl text-slate-300 mt-12 md:w-80">
